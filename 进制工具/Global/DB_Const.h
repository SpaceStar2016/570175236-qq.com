...
#define DB_BIG_NUMFONT (25)
#define DB_BIG_INDEXFONT (10)
#define DB_SINGLE_ITEMW (35)
#define DB_SINGLE_ITEMH (55)

#define DB_SMALL_NUMFONT (20)
#define DB_SMALL_INDEXFONT (5)
